...
<div>
<center><img src="resources/images/cart1.jpg" style="width:500px;height: 300px"></center>
</div>
<div>
<div class="container">
  <div>
...
<body ng-app="addToCartApp">
    ...
    cartApp.controller("addToCartCtrl", function ($scope, $http){
        ...
        $scope.addItemToCart = function (itemId) {
        	 alert("test");
            $http.put('http://localhost:8080/shoeclue/usercart/cart/addItem/'+itemId).success(function () {
        ...
        $scope.refreshCartItems = function () {
            $http.get('http://localhost:8080/shoeclue/usercart/cart/refreshCart/'+$scope.cartId).success(function (data) {
               $scope.cart=data;
            });
        };
        ...
        $scope.clearCartItems = function () {
        	$http['delete']('http://localhost:8080/shoeclue/usercart/cart/clearCartItems/'+$scope.cartId).success(function (data) {$scope.refreshCartItems()});
        };
    });
</script>
</body>
