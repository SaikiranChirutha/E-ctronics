  ...
  <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <form:form action="SignUp" method="POST" accept-charset="utf-8" class="form" role="form" commandName="usersDetail">   
                    <img src="resources/images/sign14.png" style="width:600px;height:300px">
					  ...
					  <div class="control-group">
						...
						<div class="controls docs-input-sizes">
							<form:input path="shippingAddress.zipCode" id="shippingZip" class="form-Control"/>
                                 ...
                                 <span class="help-block">By clicking Create your account, you agree to our Terms and that you have read our Data Use Policy, including our Cookie Use.</span>
